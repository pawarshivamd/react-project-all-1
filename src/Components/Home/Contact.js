                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-10 col-12">
                            <div className='row '>
                                <div className=' contact-left-side col-12 col-lg-5 ' data-aos="fade-up-right">
                                ...
                                <div className='contact-rigtside col-12 col-lg-7 d-flex justify-content-center align-items-center ' data-aos="fade-up-left">
